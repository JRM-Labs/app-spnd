/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/email-worker/wrangler.jsonc apps/email-worker/worker-configuration.d.ts` (hash: 64dc5211677335151cb88bdeb06f14ea)
// Runtime types generated with workerd@1.20260714.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "dev" | "prod";
	FIREBASE_INGEST_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "FIREBASE_INGEST_URL" | "INGEST_SHARED_SECRET">> {}
}
